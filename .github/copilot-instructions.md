Open
Exercise: Personalize Sua Experiência com o GitHub Copilot
#1
Exercise: Personalize Sua Experiência com o GitHub Copilot #1
Open
...
👋 Hey there @andremnunes! Welcome to your Skills exercise!

Aprenda a personalizar o GitHub Copilot para funcionar melhor para sua equipe e projetos.
...
Consulte a página GitHub Docs: Repository Custom Instructions para mais informações.
...
Clique com o botão direito no botão abaixo para abrir a página Create Codespace em uma nova aba. Use a configuração padrão.

Open in GitHub Codespaces

Confirme que o campo Repository é a sua cópia do exercício, não o original, e clique no botão verde Create Codespace.

✅ Sua cópia: /andremnunes/skills-customize-your-github-copilot-experience-AndreNunes
❌ Original: /skills/customize-your-github-copilot-experience
Aguarde um momento para o Visual Studio Code carregar no navegador e para que todas as extensões sejam instaladas.

Certifique-se de que a extensão Live Preview está ativada.
Certifique-se de que a extensão Python está ativada.
Clique com o botão direito em index.html e selecione Show Preview para ver o site em funcionamento.
...
No VS Code, crie um novo arquivo chamado:
...
Adicione o seguinte conteúdo para que o Copilot entenda o propósito, a estrutura e os requisitos do projeto:
...
Teste suas instruções perguntando ao Copilot sobre o projeto:

Static Badge

Explique brevemente este projeto para mim
Observe que o Copilot usa suas instruções personalizadas como referência na resposta.

Copilot response showing custom instructions reference
Faça o commit do arquivo .github/copilot-instructions.md na branch main e envie (push) para o GitHub.

Aguarde a Mona preparar o próximo passo!
...
Estarei acompanhando seu progresso em segundo plano para dar feedback. 🧐
